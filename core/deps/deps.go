...
func gitMissingMessage() string {
	...
	b.WriteString("gitswitch: git is not installed or not on your PATH.\n\n")
	b.WriteString("  gitswitch wraps git — install Git first, then restart your terminal.\n\n")
	switch runtime.GOOS {
	case "windows":
...
func sshKeygenMissingMessage() string {
	var b strings.Builder
	b.WriteString("gitswitch: ssh-keygen is not installed or not on your PATH.\n\n")
	b.WriteString("  gitswitch gen creates SSH keys using ssh-keygen.\n\n")
	switch runtime.GOOS {
	case "windows":
		b.WriteString("  Windows:\n")
